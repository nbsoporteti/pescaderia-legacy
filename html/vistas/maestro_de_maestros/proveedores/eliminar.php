<?php
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['id_usuario'])) {
        ...
        $query = "UPDATE proveedores SET estado = 2 WHERE id_proveedor = $id_usuario";

        if (mysqli_query($connect, $query)) {
            echo "Proveedor desactivado correctamente";
        } else {
            echo "Error al desactivar proveedor: " . mysqli_error($connect);
        }
